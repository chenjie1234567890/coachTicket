...
INSERT INTO `admins` VALUES ('13', 'admin', 'admin', '2019-11-23 21:43:20', '1', '1', '2019-12-21 09:53:02');
...
-- Records of member
-- ----------------------------
INSERT INTO `member` VALUES ('19', 'user', 'user', '2019-11-23 21:45:16', '1', '2019-12-21 16:25:46');
...
CREATE TABLE `pmember` (
  ...
  `sex` varchar(50) NOT NULL COMMENT '会员性别',
  ...
  CONSTRAINT `pmember_ibfk_1` FOREIGN KEY (`memberid`) REFERENCES `member` (`memberid`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of pmember
-- ----------------------------
INSERT INTO `pmember` VALUES ('17', '19', '李白', '男', '18', '360412199904062105', '2147483647', 'zhangsan@163.com');
...
CREATE TABLE `prep` (
  ...
  `trainnumber` varchar(50) NOT NULL COMMENT '火车车次',
  `starttime` varchar(50) NOT NULL COMMENT '寮€杞︽椂闂?',
  `endtime` varchar(50) NOT NULL COMMENT '鍒扮珯鏃堕棿',
...
-- Records of prep
-- ----------------------------
INSERT INTO `prep` VALUES ('134', '22', '17', '北京', '天津', 'K322', '2019-09-01 15:30:00', '2019-09-01 16:50:00', '200', '', '2019-12-21 16:20:29');
...
CREATE TABLE `train` (
  ...
  `trainnumber` varchar(50) NOT NULL COMMENT '车次',
  `startstation` varchar(50) NOT NULL COMMENT '起始站',
  `endstation` varchar(50) NOT NULL COMMENT '终点站',
  `starttime` varchar(50) NOT NULL COMMENT '瀵偓鏉烇附妞傞梻?',
  `endtime` varchar(50) NOT NULL COMMENT '閸掓壆鐝弮鍫曟？',
  `price` int(4) NOT NULL COMMENT '车票价格',
...
-- Records of train
-- ----------------------------
INSERT INTO `train` VALUES ('22', 'K322', '北京', '天津', '2019-09-01 15:30:00', '2019-09-01 16:50:00', '200', '989', '2019-09-13 23:37:52');
INSERT INTO `train` VALUES ('23', 'T23', '南昌', '九江', '2019-09-20 12:12:00', '2019-09-27 12:12:00', '1000', '97', '2019-09-19 00:03:03');
INSERT INTO `train` VALUES ('24', 'T23', '北京', '乌鲁木齐', '2019-09-28 12:21:00', '2019-09-28 12:12:00', '999', '16', '2019-09-19 00:08:16');
...
INSERT INTO `train` VALUES ('329', 'T23', '??', '??', '2019-11-22 12:12:00', '2019-11-14 12:12:00', '20', '497', '2019-11-18 18:23:36');
