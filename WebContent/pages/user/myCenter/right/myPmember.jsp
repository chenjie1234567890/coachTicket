    ...
    <form action="<%=basePath%>UpdatePmemberServlet" method="post" class="form form-horizontal" id="form-member-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" disabled="disabled" class="input-text" value="${pmember.pmemberId}" placeholder=""
                       id="" name="">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" class="input-text" value="${pmember.realName}" placeholder="" id="realName"
                       name="realName">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" class="input-text" value="${pmember.age}" placeholder="" id="age" name="age" disabled="true">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>身份证号码：</label>
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" class="input-text" value="${pmember.idCard}" placeholder="" id="idCard"
                       name="idCard">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" class="input-text" value="${pmember.phone}" placeholder="" id="phone" name="phone">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>Email：</label>
            <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
                <input type="text" class="input-text" value="${pmember.email}" placeholder="" id="email" name="email">
            </div>
        </div>
        <div class="row cl">
